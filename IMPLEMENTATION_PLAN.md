...
- [ ] Tests: Add to `tests/config.test.ts` — valid review config passes, invalid `review.scope` errors, invalid `review.output.format` errors, unknown keys produce warnings.
